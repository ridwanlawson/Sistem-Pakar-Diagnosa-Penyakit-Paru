<script type="text/javascript">
 $(document).ready(function() {
     $('#select2').select2();
      ...
      <footer class="main-footer" style="background-color: darkred;color: white;">
        <div class="footer-left">
          Copyright &copy; <?php echo date('Y') ?> <div class="bullet"></div> Design By <?php echo $judul->nm_perusahaan; ?>
        </div>
